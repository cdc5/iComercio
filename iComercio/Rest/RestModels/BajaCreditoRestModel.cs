...
{
    public class BajaCreditoRestModel : ITransmitibleCC
    {
        public CreditoAnuladoRestModel Credito { get; set; }
        public ImputacionCuentaCorrienteRestModel ImputacionCC { get; set; }

         public BajaCreditoRestModel()
        {

        }

         public BajaCreditoRestModel(CreditoAnuladoRestModel Credito, ImputacionCuentaCorrienteRestModel ImputacionCC)
        {
        ...
        {
            BajaCreditoRestModel acrm = (BajaCreditoRestModel)c;
