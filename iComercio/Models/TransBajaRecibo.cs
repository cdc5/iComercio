...
{
    public class TransBajaRecibo : Operacion
    {
          public TransBajaRecibo()             
         {
         }


          public TransBajaRecibo(int OperacionID, string Nombre, string Descripcion) :
         ...
         public async override Task<bool> Enviar(BusinessLayer bl, Transmision tran)
         {
             ...
             return  await this.DeleteConCC<AltaReciboRestModel>(bl, tran, AltaReciboRestModel);
         }
    }
}
